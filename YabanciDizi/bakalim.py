...
oturum = CloudScraper()
istek  = oturum.get("https://yabancidizi.tv/film/mission-impossible-ghost-protocol")
...
#     "dbxu"          : "1722403730363"
# })
oturum.headers.update({"Referer": "https://yabancidizi.tv/film/mission-impossible-ghost-protocol"})
